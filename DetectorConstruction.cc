...
//propfiber->AddConstProperty("WLSABSLENGTHMAX", 2.90*eV); // Absorption peak
//propfiber->AddConstProperty("WLSCOMPONENTMAX", 2.90*eV); // Emission peak
